...
const BlogCard = ({ image, index, date, title, content, linkText, linkHref }) => (
  <>
    ...
    <div className="border rounded-lg shadow-sm p-6 flex flex-col justify-between h-[483px]">
      ...
      <div>
        <h3 className="text-[24px] font-normal mb-5 text-gray-900 mt-2 " dangerouslySetInnerHTML={{ __html: title }} />
