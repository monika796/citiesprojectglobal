...
<footer className="container max-w-[1481px] mx-auto md:mt-[60px]">
  <div className=" hidden md:flex w-[100%] mx-auto flex flex-wrap items-center justify-between mx-auto border-t border-b border-solid border-black">
        ...
        <div className="flex gap-[40px] md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <button type="button" className="text-black font-bold ">< Link href="/book">
            Book </Link>
          </button>
         
          <button type="button" className="  m-[25px] text-black font-bold">  < Link href="/donation">
            Donate Now!
    ...
    <div className="mx-auto w-full">
      ...
      />
        ...
        <div className="grid justify-start items-start">
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <Link href="https://www.facebook.com/CitiesProjectGlobal/" className="text-black  underline">Facebook</Link>
                </li>
                <li className="mb-4">
                    <Link href="https://www.linkedin.com/company/citiesprojectglobal" className="text-black  underline">Linkedin</Link>
                </li>
                <li className="mb-4">
                    <Link href="https://www.instagram.com/citiesprojectglobal/" className="text-black  underline">Instagram</Link>
                </li>
            </ul>
        </div>
        <div className="grid justify-start items-start">
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <Link href="/terms-of-use" className="text-black  underline">Terms of Use</Link>
                </li>
                <li className="mb-4">
                    <Link href="/privacy-statement" className="text-black  underline">Privacy Statement</Link>
                </li>
                <li className="mb-4">
                    <Link href="#" className="text-black underline">© CitiesProjectGlobal 2024</Link>
                </li>
            </ul>
        </div>
    </div>
