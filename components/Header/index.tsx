  ...
  return (
    <header
      className={`sticky  left-0 top-0 z-99999 md:pt-0 w-full ${stickyMenu
          ? "bg-[#111827a3] backdrop-blur-lg	 !text-white !py-4 shadow transition duration-100 dark:bg-[#111827a3]"
          : ""
    ...
    >
      ...
      >
        ...
        {/* Nav Menu Start   */}
        <div
          className={`${scrollDirection=='hidden' ? "" : "md:visible" }  headermenutabcss  invisible h-0 w-full  items-center justify-center  md:flex md:h-auto md:w-full ${navigationOpen &&
